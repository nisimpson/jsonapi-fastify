...
import { JsonapiErrorObject, ResourceDocument, UpdateRelationDocument } from 'jsonapi-spec';
import type { FieldDefinition } from '../schemas/fields';
import type { Handler, HandlerResult } from './handler';
import { SerializerOptions, Serializer } from 'jsonapi-serializer';
...
export type JsonapiContext = {
  ...
  baseUrl: string;
  document?: ResourceDocument | UpdateRelationDocument;
  serializer(type: string, options: SerializerOptions): Serializer;
